                                ...
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input
                                            ...
                                            name="email" type="text" className={`w-full text-slate-900 text-sm px-4 py-3 pr-8 outline-[#2173ea] ${errors.email ? 'border border-red-600' : 'border border-slate-300'}`} placeholder="Enter email"
                                        />
                                    </div>
                                    {errors.email && (
