                                    ...
                                    <div>
                                        ...
                                        <div className="relative flex items-center">
                                            <input
                                                ...
                                                name="confirm-password" type={confirmPasswordToggle ? "text" : "password"} className="w-full text-slate-900 text-sm border border-slate-300 px-4 py-3 pr-8 rounded-md outline--[#2173ea]" placeholder="Confirm password"
                                            />
                                    ...
                                    <div>
                                        ...
                                        <div className="relative flex items-center">
                                            <input
                                                ...
                                                name="address" type="text" className="w-full text-slate-900 text-sm border border-slate-300 px-4 py-3 pr-8 rounded-md outline-[#2173ea]" placeholder="123 Street, XYZ City"
                                            />
                                        </div>
                                    </div>
